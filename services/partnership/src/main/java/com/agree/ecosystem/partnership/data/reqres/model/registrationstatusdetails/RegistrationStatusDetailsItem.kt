...
data class RegistrationStatusDetailsItem(
    ...
    val subSectors: List<SubSectorItem>? = null,
    ...
    fun toRegistrationStatusDetails(): RegistrationStatusDetails {
        return RegistrationStatusDetails(
            ...
            provinceName = provinceName.orEmpty().capitalizeWords(),
            districtName = districtName.orEmpty().capitalizeWords(),
            subDistrictName = subDistrictName.orEmpty().capitalizeWords(),
            villageName = villageName.orEmpty().capitalizeWords(),
            ...
            subSectors = subSectors?.map { it.toSubSector() }.orEmpty(),
