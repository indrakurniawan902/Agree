...
import com.agree.ecosystem.utilities.data.reqres.db.UtilitiesDbImpl
...
interface UtilitiesModule : ViewModelModule {
    ...
    fun provideUtilitiesDatabase(): Module {
        return module {
            single { createRoomDb<UtilitiesDatabase>(androidContext(), UtilitiesDatabase.getDbName()) }
            single { UtilitiesDbImpl(get()) } bind UtilitiesDb::class
        }
    }
