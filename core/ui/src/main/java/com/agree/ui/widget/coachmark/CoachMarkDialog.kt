...
class CoachMarkDialog(
    private val builder: CoachMark.Builder?
) : DialogFragment() {
    ...
    companion object {
        ...
        fun newInstance(
            ...
            Companion.coachMarks = coachMarks
            Companion.fragmentActivity = fragmentActivity
            return CoachMarkDialog(builder)
        }
        ...
        fun getStatusBarHeight(context: Context): Int {
            ...
            if (height == 135) height += 36 // some emu aren't in the right position
            return height
        }
    }
